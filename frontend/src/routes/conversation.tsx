  ...
  function renderMain() {
    ...
    return (
      <ResizablePanel
        ...
        initialSize={500}
        firstClassName="rounded-xl overflow-hidden border border-neutral-600 bg-base-secondary shadow-lg shadow-black/20"
    ...
    <WsClientProvider conversationId={conversationId}>
      <EventHandler>
        <div data-testid="app-route" className="flex flex-col h-full gap-3">
          <div className="flex h-full overflow-auto rounded-xl shadow-xl">{renderMain()}</div>
